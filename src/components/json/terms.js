export const GrabitTerms = [
  {
    idx: 0,
    head: '제 1조(목적)',
    content: `본 약관(이하 "약관")은 개발팀 ‘HABEAT’가 개발한 그래빗(Grabit)에서 제공하는 그래빗(Grabit) 어플리케이션 서비스(이하”서비스”) 내에서 회원의 습관개선을 위한 개인습관, 단체습관모임 개설 및 참여, 진행 방식과 관련하여 “HABEAT”와 “회원”의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.`,
  },
  {
    idx: 1,
    head: '제 2조(용어의 정의)',
  ...
  },
  {
    ...
    content: `1. "개발팀"은 약관 및 개인정보 수집방침을 "회원" 이 확인할 수 있도록 서비스 화면에 하이퍼링크의 형태 또는 메뉴의 형태 등으로 제공합니다.
...
5. “회원”이 개정약관의 적용에 동의하지 않는 경우 “개발팀” 또는 “회원”은 이용계약을 해지할 수 있습니다.`,
  },
  {
    idx: 3,
    head: '제4조 (약관의 명시와 개정)',
    content: `본 약관에서 정하지 않은 사항이나 해석에 대하여는 관련 법령 또는 상관례에 따릅니다.
  ...
  {
    idx: 4,
    head: '제5조 (이용계약의 체결 및 거절)',
    content: `1. “서비스”의 이용계약은 회원이 되고자 하는 자(이하 “가입신청자”)가 본 약관에 동의하고 가입을 신청한 다음 개발팀이 이를 수락함으로써 체결됩니다. 필요한 경우 개발팀은 본인 확인 기관을 통한 실명확인 및 본인인증을 요청할 수 있습니다.
