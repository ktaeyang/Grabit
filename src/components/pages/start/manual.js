...
function Final(props) {
  return (
    <View style={styles.subDiv}>
      <Text style={[styles.manualTxt, {marginTop: 30}]}>
        사람들과의 모임을 통해
      </Text>
      <Image
        style={[styles.manualImg, {marginTop: 20}]}
        source={homeImages.home4}
      />
...
function Manual3(props) {
  return (
    <View style={styles.subDiv}>
      ...
      <Image style={styles.manualImg} source={require(homeImages.home3)} />
      <Image
        style={styles.dotImg}
        source={require('../../../image/dot3.png')}
      />
...
function Manual2(props) {
  return (
    <View style={styles.subDiv}>
      ...
      <Image style={styles.manualImg} source={homeImages.home2} />
      <Image
        style={styles.dotImg}
        source={require('../../../image/dot2.png')}
      />
      <Text style={styles.manualTxt}>어떤 습관을 가지고 있느냐에 따라</Text>
      <Text style={styles.manualTxt2}>나를 성장시킬 수 있습니다.</Text>
      <TouchableOpacity
        onPress={() => {
          props.setManual3(true);
          props.setManual2(false);
        }}
        style={styles.purpleBtn}>
        <Text style={styles.purpleBtnTxt}>다음</Text>
      </TouchableOpacity>
...
export default function Manual1(props) {
  ...
  return (
    <View style={styles.background}>
      ...
      <Image style={styles.manualImg} source={homeImages.home1} />
      <Image
        style={styles.dotImg}
        source={require('../../../image/dot1.png')}
      />
      <Text style={styles.manualTxt}>우리 행동의 40% 이상이</Text>
      <Text style={styles.manualTxt2}>습관에 의한 결정입니다.</Text>
      <TouchableOpacity
        onPress={() => setManual2(true)}
        style={styles.purpleBtn}>
        <Text style={styles.purpleBtnTxt}>다음</Text>
      </TouchableOpacity>
      {manual2 ? (
        <Manual2
          setManual3={setManual3}
          setFinal={setFinal}
          setManual2={setManual2}
          setApp={props.setApp}
        />
      ) : undefined}
      {manual3 ? (
