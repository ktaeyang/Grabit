...
function Service() {
  return (
    <View style={[styles.subDiv]}>
      <Image
        style={{marginHorizontal: 160, marginTop: 120, marginBottom: 20}}
        source={require('../../../image/question_icon.png')}
      />
      ...
      <TouchableOpacity
        onPress={() => console.log('..')}
        style={[styles.prevBtn3, {borderColor: '#7D63EB'}]}>
...
function Logout(props) {
  ...
  return (
    <View style={[styles.subDiv]}>
      ...
      {signout ? (
        <Signout setSignout={setSignout} email={props.email} />
      ) : undefined}
    </View>
  );
}
