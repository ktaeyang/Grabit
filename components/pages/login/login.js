...
function CompleteJoin(props){
    return(
        ...
        <View style={styles.subDiv2}>
            ...
            <Image style={[styles.checkImg, {marginTop: 200}]} source={props.isAlone ? require("../../../image/aloneCheck.png") : require("../../../image/togetherCheck.png")} />
            <Text style={{marginVertical:20,color: 'black', fontWeight: '900',textAlign: 'center', fontSize: 20}}><Text style={{color: "#7D63EB"}}>회원가입</Text> 완료</Text>
            <Text style={{textAlign: 'center', color: 'black'}}>습관을 바꾸는 것만으로도</Text>
            <Text style={{textAlign: 'center', color: 'black'}}>자신의 인생을 바꿀 수 있다.</Text>
            <Text style={{textAlign: 'center', color: 'black'}}>- <Text>윌리엄 제임스</Text> -</Text>
            <TouchableOpacity onPress={() => props.setApp("home")} style={styles.prevBtn3}>
                <Text style={styles.purpleBtnTxt}>홈으로 가기</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => props.setApp('add')} style={styles.purpleBtn}>
    ...
    return(
        <View style={styles.subDiv2}>
            ...
            <View style={[styles.category, {marginTop: 80}]}>
                <TouchableOpacity onPress={() => setHobby("LIFE")} style={styles.categoryBtn}>
                <Image source={require("../../../image/habit1.png")} />
                    <Text style={styles.categoryTxt}>생활습관</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setHobby("HEALTH")} style={styles.categoryBtn}>
                <Image source={require("../../../image/habit2.png")} />
                    <Text style={styles.categoryTxt}>건강습관</Text>
                </TouchableOpacity>
            </View>
            <View style={styles.category}>
                <TouchableOpacity onPress={() => setHobby("GROW")} style={styles.categoryBtn}>
                <Image source={require("../../../image/habit3.png")} />
                    <Text style={styles.categoryTxt}>성장습관</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setHobby("ECONOMY")} style={styles.categoryBtn}>
                    <Image source={require("../../../image/habit4.png")} />
                    <Text style={styles.categoryTxt}>경제습관</Text>
                </TouchableOpacity>
            </View>
            <View style={styles.category}>
                <TouchableOpacity onPress={() => setHobby("FOR_ME")} style={styles.categoryBtn}>
                <Image source={require("../../../image/habit5.png")} />
                    <Text style={styles.categoryTxt}>나를 위한 습관</Text>
                </TouchableOpacity>
            </View>
            <TouchableOpacity activeOpacity={1} onPress={() => props.setHobby(false)} style={[styles.prevBtn,{marginTop: 175}]}>
...
function Icon(props){
    ...
    return (
        <View style={styles.subDiv2}>
            <Text style={{marginTop: 40, marginLeft: 40, fontSize: 20, color:'black'}}>프로필로 사용할</Text>
            <Text style={{marginLeft: 40, fontSize: 20, color:'black'}}>아이콘을 선택해 주세요!</Text>
            ...
            <TouchableOpacity activeOpacity={1} onPress={() => props.setIcon(false)} style={styles.prevBtn}>
                <Image source={require("../../../image/prevArrow.png")} style={styles.prevArrow} />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => setHobby(true)} style={styles.purpleBtn}>
                <Text style={styles.purpleBtnTxt}>결정하기</Text>
            </TouchableOpacity>
            {hobby ? <Hobby age={props.age} gender={props.gender} email={props.email} name={props.name} password={props.pswd} setHobby={setHobby} iconId={icon} setApp={props.setApp} /> : undefined}
        </View>
    )
}
...
function ForgotPW(props){
    ...
    return(
        <View style={styles.subDiv}>
            <Text style={{textAlign: 'center', fontWeight: '900', marginTop: 200, fontSize: 25, color: 'black'}}>비밀번호 찾기</Text>
            <Text style={{textAlign:'center', paddingTop: 10}}>가입하신 이메일로 비밀번호 변경 메일을</Text>
            <Text style={{textAlign: 'center', paddingBottom: 40}}>보내드립니다.</Text>
            <View>
            ...
            <TouchableOpacity onPress={() => forgotPasword()} style={styles.purpleBtn}>
...
function UserPromise(props){
    return (
        ...
        hidden = {true} />
            <Image style={{width:'100%'}} source={require("../../../image/selectHeader.png")} />
            <View style={{position:'absolute', flexDirection: 'row'}}>
                <TouchableOpacity onPress={() => {props.setUserPromise(false)}}>
                    <Image style={styles.preBtn} source={require("../../../image/preBtn.png")} />
                </TouchableOpacity>
                <Text style={{color: 'white', fontSize: 20, width: 400, marginLeft: 120, fontWeight: '900', top: 30}}>서비스 이용약관</Text>
            </View>
            <Text style={{marginTop: 20, marginLeft: 20}}>서비스 이용약관</Text>
            <View style={{height: 250}}>
            <ScrollView style={{backgroundColor:'#F5F5F5B2', margin:20, marginBottom: 10, padding: 10, borderRadius: 15}}>
                <Text>
                Grabit 서비스 이용약관
                ...
                07."개발팀"은 서비스의 홍보 내지 개선을 위해 "메모"를 사용할 수 있으며, 이러한 목적 범위 내에서 “메모”에 대한 편집, 수정, 복제 등의 행위를 할 수 있습니다.
...
function Join(props){
    ...
    return(
        <View style={styles.subDiv}>
            ...
            <Text style={styles.loginTxt4}>아이디를 만들어 그래빗을 시작해보세요!</Text>
            <View>
            ...
            <View>
                <Image style={styles.icon} source={require("../../../image/pswd.png")} />
                <TextInput
                    placeholder='비밀번호'
                    style={styles.textName}
                    value={pswd}
            ...
            <View style={{flexDirection:'row', marginHorizontal: 20}}>
                <TouchableOpacity style={gender ? styles.thisGender : styles.noGender} onPress={() => setGender(true)}>
                    <Text>남</Text>
                </TouchableOpacity>
                <TouchableOpacity style={gender ? styles.noGender : styles.thisGender} onPress={() => setGender(false)}>
                    <Text>여</Text>
                </TouchableOpacity>
            </View>
            <View style={{ marginHorizontal: 20}}>
                <Text style={{padding:10,marginTop:10}}>나이대</Text>
                <RNPickerSelect onValueChange={(value) => setAge(value)}
                items={[
                    { label: '0대', value: 0 },
                    { label: '10대', value: 10 },
                    { label: '20대', value: 20 },
            ...
            <View style={{flexDirection:'row', marginHorizontal: 20}}>
                ...
                />
                <View>
                <Text>계정을 생성함으로써 귀하는 당사의 <TouchableOpacity onPress={() => setUserPromise(true)}><Text>이용 약관</Text></TouchableOpacity>에</Text>
                <Text>동의하는 것입니다.</Text>
                </View>
            </View>
            <Text style={{color: 'red', paddingLeft: 20, paddingTop: 10}}>{warn}</Text>
            ...
            <View style={{flexDirection:'row', marginHorizontal: 120}}>
                <Text>계정이 있으신가요? </Text>
                <TouchableOpacity onPress={() => props.setJoin(false)}><Text style={{color: '#7d63e8'}}>로그인</Text></TouchableOpacity>
            </View>
            {userPromise ? <UserPromise setUserPromise={setUserPromise} /> : undefined}
            {icon ? <Icon age={age} gender={gender ? "MALE" : "FEMALE"} email={email} name={name} password={pswd} setIcon={setIcon} setApp={props.setApp} /> : undefined}
        </View>
    )
}
...
export default function Login(props){
    ...
    return (
        ...
        barStyle='dark-content' />
            ...
            <TouchableOpacity onPress={() => insertLogin(email, pswd)} style={styles.purpleBtn}>
